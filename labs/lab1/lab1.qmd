...
#     other-links:
#       - text: "Specifications"
#         href: https://hmc-e155.github.io/lab/lab1/specs.html
...
![Completed E155 Development Board](images/SolderFront.jpeg) 
...
![Lab 1 Block Diagram](images/Lab1BlockDiagram.png) 
...
![Resistor Calculations for Seven Segment Display](images/resistorcalculations.jpeg) 

I opted to use resistor values of 240 ohms, producing 6.25 mA of current. 

A wiring schematic is shown below. 
![Lab 1 Circuit Schematic, Victoria Parizot, 09/04/2024](images/CircuitDiagram.jpeg) 

Here is a photo of the implemented design!
![Completed Circuit](images/SevenSegments.jpeg) 
...
![Wave forms of test bench](images/wave2.png) 


I tested the blinking led[2] with the oscilliscope to confirm it had a frequency of 2.4 hz.
![Frequency verification of led[2]](images/240HzLed%5B2%5D.png) 
