...
![Keypad Scanner FSM](images/ScanFSM.jpeg) 
...
![Button Debouncing FSM](images/keyDebounceFSM.jpeg) 
...
![Lab 3 Block Diagram](images/block.jpeg) 
...
![ScanFSM Test Bench](images/scanfsm-tb.png) 
![Shifter Test Bench](images/shifter-tb.png) 
![keyBounce Test Bench](images/keyBounce-tb.png) 
...
![Lab 3 Circuit Diagram](images/circuitDiagramlab3.jpeg) 
...
## Conclusion
Lab 3 proved that simulation prior to implementation is a necessity. As a result, I grew familair with fully defining my system, and how to debug. 
