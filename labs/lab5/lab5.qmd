...
![Interrupt Flow Chart](images/flowchart1.jpeg) 

We know that encoder A and B will alternate in triggering the interrupt, due to their relationship. Thus, I kept track of the distance between and edge of A and B in the delCount variable. If the interrupt was triggered by Encoder B, then TIM16 CNT was set to zero. If the interrupt was triggered by Encoder A, then the count would be copied into the delCount variable. 

![delCount with the Encoder Pulses](images/delCount.jpeg) 
...
![Calculating speed in [rev/s] from delCount](images/speedCalculations.jpeg) 

To determine the direction of the motor, I used conditional statements in my interrupt handler. 
# INSERT HERE about direction
...
![Oscilloscope Screen Capture for 12V](images/Osc12V.png) 
![Freq Calculations for Oscilloscope Data at 12V](images/CalcOsc12V.jpeg) 
...
## Demonstration
I've attatched a video of the printed output of the motor as I vary the motor input voltage. 
# include screen video
<!-- ####################### -->
<!-- ####################### -->
<!-- ####################### -->
<!-- ####################### -->
