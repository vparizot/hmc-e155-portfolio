...
![MCU Timer Design Outline](images/MCU_TIM_Outline.jpeg) 

### MSI Clock
I set the MSI Clock at it's default frequency of 4 Mhz. The clock's output frequency can be calculated with: 
$Output freq = (srcclk) * (N/M) / R$
...
The maximum value of $ARR = 1$, doing similair calculations as before, 
$max_{pitch} = \frac{100 kHz}{ARR} = \frac{100 kHz}{1}$ = 100 kHz
$max_{pitch} = 100 kHz$
...
## Hardware Design
An LM386 audio amplifier [[LM386 Datasheet]](https://www.ti.com/lit/ds/symlink/lm386.pdf) was used to interface MCU pin PA6 with an 8 Ohm speaker.

![Lab 4 Wiring Diagram](images/WiringDiagram.jpeg) 
...
{{< video https://youtu.be/j1fOJsa13eE >}}
