...
If we do end up pursuing this path, I want to convince our Linde president friends to let us DJ at the start of their 5C using our MicroPs board. Not sure how we will be able to handle the current required to go into 5 different speakers, but it's a cool idea and a thinking exercise.
